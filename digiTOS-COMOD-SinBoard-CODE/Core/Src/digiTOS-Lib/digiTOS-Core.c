...
//temp Buffer
volatile uint32_t V_1_temp=0;
volatile uint32_t V_2_temp=0;
volatile uint32_t V_3_temp=0;
volatile uint32_t V_4_temp=0;

volatile uint32_t Vcnt_1_temp=0;
volatile uint32_t Vcnt_2_temp=0;
volatile uint32_t Vcnt_3_temp=0;
volatile uint32_t Vcnt_4_temp=0;

volatile uint32_t I_Out_RawData_temp=0;
volatile uint32_t V_Out_RawData_temp=0;
volatile uint32_t I_Out_Cnt_temp=0;
volatile uint32_t V_Out_Cnt_temp=0;
